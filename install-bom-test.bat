@echo off
setlocal
set "URL=https://raw.githubusercontent.com/ritco/spinnekop-tools/main/installers/install-bom-test.ps1"
set "TMPFILE=%TEMP%\install-bom-test.ps1"

echo BOM Import Tool - Installatie (TEST)
echo =============================================
echo.
