# =============================================================================
# ePlan Import Tool - Installatie (TEST / pre-release versies)
# =============================================================================
# Gebruik: PowerShell -ExecutionPolicy Bypass -File install-eplan-test.ps1
# =============================================================================
...
$default_dir = "C:\Tools\ePlan-Import-Test"
