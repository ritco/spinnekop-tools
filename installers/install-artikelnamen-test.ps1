# =============================================================================
# Artikelnamen Tool - Installatie (TEST / pre-release versies)
# =============================================================================
# Gebruik: PowerShell -ExecutionPolicy Bypass -File install-artikelnamen-test.ps1
# =============================================================================
...
$default_dir = "C:\Tools\Artikelnamen-Test"
