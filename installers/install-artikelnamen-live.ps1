# =============================================================================
# Artikelnamen Tool - Installatie (LIVE / stabiele versies)
# =============================================================================
# Gebruik: PowerShell -ExecutionPolicy Bypass -File install-artikelnamen-live.ps1
# =============================================================================

$ErrorActionPreference = "Stop"
[Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls12

$EXE_NAME     = "artikelnamen.exe"
...
$default_dir = "C:\Tools\Artikelnamen"
...
try {
    ...
    $release = $releases | Where-Object { $_.tag_name -like "$TOOL_PREFIX*" -and $_.prerelease -eq $false } | Select-Object -First 1
    if (-not $release) { throw "Geen stabiele release gevonden voor '$TOOL_PREFIX' in repo $GITHUB_REPO" }
...
try {
    Invoke-WebRequest -Uri $download_url -OutFile $exe_path -TimeoutSec 180 -UseBasicParsing
...
Write-Host "  Kanaal  : LIVE (stabiele updates)"
Write-Host ""
