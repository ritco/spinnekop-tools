# =============================================================================
# ePlan Import Tool - Installatie (LIVE / stabiele versies)
# =============================================================================
# Gebruik: PowerShell -ExecutionPolicy Bypass -File install-eplan-live.ps1
# =============================================================================

$ErrorActionPreference = "Stop"
[Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls12

$EXE_NAME     = "eplan-import-tool.exe"
$GITHUB_REPO  = "ritco/spinnekop-tools"
$CHANNEL      = "stable"
$DISPLAY_NAME = "ePlan Import Tool"
$TOOL_PREFIX  = "eplan-"
...
$default_dir = "C:\Tools\ePlan-Import"
